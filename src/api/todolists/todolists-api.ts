...
export const todolistsAPI = {
  getTodolists() {
    return instance.get<Record<string, never>, AxiosResponse<Array<TodolistResponseDataType>>>(
      '/todo-lists',
    )
  },
  createTodolist(title: string) {
    return instance.post<
      { title: string },
      AxiosResponse<ServerResponseType<ItemResponseType<TodolistResponseDataType>>>
    >('/todo-lists', { title })
  },
  updateTodolistTitle(title: string, todolistId: string) {
    return instance.put<{ title: string }, AxiosResponse<ServerResponseType>>(
